  ...
  mock: {
    ...
    data: {
      ...
      menu_ad_cfg: {
        ...
        gm_url: '', //	客服url
        xieyi_url: 'http://api.gowan8.com/xieyi.html', // 协议url
        wx_app_name: '', // 微信公众号名
        wx_code: '' // 微信公众号二维码
      }
    }
...
// 2.用户登陆
Api.define('gowansdk:login', {
  input: {
    ct: 'user',
    ac: 'login',
    ...globalHeader,
    mode: 0, // 必填登陆模式：0:账号密码登陆/1:手机验证码登陆
...
// 4.发送手机验证码
Api.define('gowansdk:sendAuthCode', {
  input: {
    ct: 'send_code',
    ...globalHeader,
  ...
  mock: {
    ...
    msg: '',
    data: {
      code_sign: '76b5177138b465c509acb21b77c7c348a3f860be', // 手机验证码签名信息
      timeout: 1533016325 // 过期时间戳，秒
...
// 8.修改用户信息
Api.define('gowansdk:updateInfo', {
  input: {
    ct: 'user',
    ac: 'update_info',
    ...globalHeader,
...
// 10.获取职业列表
Api.define('gowansdk:occupation', {
  input: {
    ct: 'cfg',
    ac: 'occupation',
    ...globalHeader,
...
Api.define('gowansdk:paramsLoad', {
  input: {
    ct: 'h5sdk',
    ac: 'js_load',
...
Api.define('gowansdk:unBindPhone', {
  input: {
    ...globalHeader,
    ct: 'user',
    ac: 'unbind_phone',
