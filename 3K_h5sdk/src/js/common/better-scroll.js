...
;(function(global, factory) {
  typeof exports === "object" && typeof module !== "undefined"
    ...
    : typeof define === "function" && define.amd ? define(factory) : (global.BScroll = factory())
})(this, function() {
  "use strict"
        ...
        if (this.options.wheel) {
          if (this.target && this.target.className === this.options.wheel.wheelWrapperClass) {
            ...
            var _offset = Math.round(
              (this.pointY + offset(this.target).top - this.itemHeight / 2) / this.itemHeight
            )
    ...
    BScroll.prototype._initSnap = function() {
      ...
      if (snap.listenFlick !== false) {
        this.on("flick", function() {
          ...
          _this._goToPage(
            _this.currentPage.pageX + _this.directionX,
            _this.currentPage.pageY + _this.directionY,
            time
          )
        })
      }
  ...
  Indicator.prototype._calculate = function() {
    if (this.direction === "vertical") {
      ...
      this.indicatorHeight = Math.max(
        Math.round(
          wrapperHeight * wrapperHeight / (this.scroller.scrollerHeight || wrapperHeight || 1)
        ),
        INDICATOR_MIN_LEN
      )
      this.indicatorStyle.height = this.indicatorHeight + "px"
      ...
      this.indicatorWidth = Math.max(
        Math.round(
          wrapperWidth * wrapperWidth / (this.scroller.scrollerWidth || wrapperWidth || 1)
        ),
        INDICATOR_MIN_LEN
      )
      this.indicatorStyle.width = this.indicatorWidth + "px"
