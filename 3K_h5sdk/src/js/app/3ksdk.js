...
import "../../assets/3ksdk/js/ui.js"   // sdk的ui

//微信自动登录地址
let wxDomain = 'ptuser.3k.com/?ct=user&ac=user_oauth_base&callbackUrl='
...
window.__3kapi_cz = {
    local: 'payapitest.3kwan.com',
    dev: 'payapitest.3kwan.com',
    test: 'payapitest.3kwan.com',
    prod: 'payapi.3k.com',
    get() {
...
;(async () => {
    let res = await FN._3k_sdk_ajax('3ksdk:paramsLoad', {
        ct: 'h5sdk',
        ac: 'js_load',
        '3k_param': decodeURIComponent(params['3k_param'])
    })
