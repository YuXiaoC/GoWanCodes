;(function(global, factory) {
  typeof exports === "object" && typeof module !== "undefined"
    ...
    : typeof define === "function" && define.amd ? define(factory) : (global.Api = factory())
})(this, function() {
  "use strict"
...
***************************************************************************** */
  ...
  function warn() {
    ...
    if (hasConsole) console.warn.apply(console, arg)
  }
  function log() {
    var arg = []
    for (var _i = 0; _i < arguments.length; _i++) {
    ...
    if (hasConsole) console.log.apply(console, arg)
  }
  function error() {
    var arg = []
    for (var _i = 0; _i < arguments.length; _i++) {
    ...
    if (hasConsole) console.error.apply(console, arg)
  }
  ...
  var copyProp = function(o, t) {
    return Object.keys(o).forEach(function(e) {
      return (t[e] = o[e])
    })
  }
  var Obj2QueryString = function(o) {
  ...
  function createJsonp(_a) {
    var href = _a.href,
      timeout = _a.timeout,
      callbackName = _a.callbackName,
      callbackId = _a.callbackId
    var id = callbackId || generateCallback()
    var mark = /\?/.test(href) ? "&" : "?"
  ...
  var globalConfig = {}
  var Api = {
    define: function(namespace, userConfig) {
      if (userConfig === void 0) {
        userConfig = {}
      }
      if (apiSet[namespace]) warn("redefine " + namespace)
      apiSet[namespace] = new Entity(userConfig)
    },
    config: function(userConfig) {
      if (userConfig === void 0) {
        userConfig = {}
      }
      copyProp(userConfig, globalConfig)
    },
    require: function(namespace, data, config) {
      ...
      if (!apiSet[namespace]) this.define(namespace)
      var entity = apiSet[namespace]
      log("" + namespace, data)
      entity.mixins(
        __assign({}, DEFAULT_OPTIONS, globalConfig, entity, config, {
          namespace: namespace,
          input: data
        })
      )
